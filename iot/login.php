        ...
        <div class="w3-display-position" style="top:250px; right:250px;">
          <form method="POST" action="verify.php">
            <div class="log-reg-box">
              <h1 style="font-family:googlesans">Login</h1>
              <div class="textbox">
                <input type="text" placeholder="E-mail" name="username" value="" required tabindex="1">
              </div>
              <div class="textbox">
                <input type="password" placeholder="Password" name="pwd" value="" required tabindex="2">
              </div>
              <input style="font-family:googlesans" class="btn" type="Submit" name="" value="Sign in" tabindex="3">
              <input style="font-family:googlesans" class="btn" type="button" onclick="location.href='register.php';" name="" value="Register" tabindex="4">
            </form>
          </div>
        </div>
